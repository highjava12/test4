...
import com.neo.security.asn1.x509.RSAPublicKeyStructure;
import com.neo.security.encoders.Base64;
        ...
        throws IOException
    {
        ...
        try
        {
            CertificateFactory certFact
                    = CertificateFactory.getInstance("X.509", NeoProvider.PROVIDER_NAME);
