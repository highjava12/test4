...
import com.neo.security.asn1.DEREnumerated;
...
import com.neo.security.asn1.x509.AccessDescription;
import com.neo.security.asn1.x509.AlgorithmIdentifier;
import com.neo.security.asn1.x509.AuthorityInformationAccess;
import com.neo.security.asn1.x509.AuthorityKeyIdentifier;
...
import com.neo.security.asn1.x509.qualified.Iso4217CurrencyCode;
import com.neo.security.asn1.x509.qualified.MonetaryValue;
import com.neo.security.asn1.x509.qualified.QCStatement;
import com.neo.security.certpath.AnnotatedException;
import com.neo.security.certpath.CertPathValidatorUtilities;
import com.neo.security.certpath.PKIXNameConstraintValidator;
import com.neo.security.certpath.PKIXNameConstraintValidatorException;
import com.neo.security.certpath.PKIXPolicyNode;
import com.neo.security.i18n.ErrorBundle;
import com.neo.security.i18n.LocaleString;
import com.neo.security.i18n.filter.TrustedInput;
import com.neo.security.i18n.filter.UntrustedInput;
import com.neo.security.i18n.filter.UntrustedUrlInput;
import com.neo.security.provider.NeoProvider;
import com.neo.security.x509.extension.X509ExtensionUtil;
...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities
{
    ...
    private static final String RESOURCE_NAME = "com.neo.security.certpath.CertPathReviewerMessages";
    ...
    private X509CRL getCRL(String location) throws CertPathReviewerException
    {
        ...
        try
        {
            ...
            if (url.getProtocol().equals("http") || url.getProtocol().equals("https"))
            {
                ...
                {
                    CertificateFactory cf = CertificateFactory.getInstance("X.509",NeoProvider.PROVIDER_NAME);
