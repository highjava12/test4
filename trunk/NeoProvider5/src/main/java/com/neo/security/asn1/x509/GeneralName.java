...
import com.neo.security.asn1.util.IPAddress;
    ...
    implements ASN1Choice
{
        ...
        String    name)
    {
        ...
        else if (tag == iPAddress)
        {
            ...
            {
                obj = new DEROctetString(Strings.toUTF8ByteArray(name));
            }
            else
            {
	...
	public String getStringName()
	{
		...
		case	2:
		case	6:
			return DERIA5String.getInstance(obj).getString();
		case	8:
			return new String(ASN1OctetString.getInstance(obj).getOctets());
		default:
			return "";
