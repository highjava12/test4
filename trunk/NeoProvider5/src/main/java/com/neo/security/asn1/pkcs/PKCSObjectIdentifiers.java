...
public interface PKCSObjectIdentifiers
{
	...
	static final DERObjectIdentifier    kisa_randomNum             = new DERObjectIdentifier("1.2.410.200004.10.1.1.3");
    ...
    static final DERObjectIdentifier    id_PasswordBasedMAC  = new DERObjectIdentifier("1.2.840.113533.7.66.13");
}
