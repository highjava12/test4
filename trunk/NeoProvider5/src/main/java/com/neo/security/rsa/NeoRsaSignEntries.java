 ...
 */
public final class NeoRsaSignEntries {

    private NeoRsaSignEntries() {
        // empty
    }
    ...
    public static void putEntries(Map<Object, Object> map) {
        ...
        map.put("KeyFactory.RSA",
                "com.neo.security.rsa.RSAKeyFactory");
        map.put("KeyPairGenerator.RSA",
                "com.neo.security.rsa.RSAKeyPairGenerator");
        map.put("Signature.MD2withRSA",
                "com.neo.security.rsa.RSASignature$MD2withRSA");
        map.put("Signature.MD5withRSA",
                "com.neo.security.rsa.RSASignature$MD5withRSA");
        map.put("Signature.SHA1withRSA",
                "com.neo.security.rsa.RSASignature$SHA1withRSA");
        map.put("Signature.SHA256withRSA",
                "com.neo.security.rsa.RSASignature$SHA256withRSA");
        map.put("Signature.SHA384withRSA",
                "com.neo.security.rsa.RSASignature$SHA384withRSA");
        map.put("Signature.SHA512withRSA",
                "com.neo.security.rsa.RSASignature$SHA512withRSA");
