...
import com.neo.security.asn1.ASN1OutputStream;
...
import com.neo.security.asn1.misc.MiscObjectIdentifiers;
import com.neo.security.asn1.misc.NetscapeCertType;
import com.neo.security.asn1.misc.NetscapeRevocationURL;
import com.neo.security.asn1.misc.VerisignCzagExtension;
import com.neo.security.asn1.util.ASN1Dump;
import com.neo.security.asn1.x509.BasicConstraints;
import com.neo.security.asn1.x509.KeyUsage;
import com.neo.security.asn1.x509.X509CertificateStructure;
import com.neo.security.asn1.x509.X509Extension;
import com.neo.security.asn1.x509.X509Extensions;
import com.neo.security.bcutil.Arrays;
import com.neo.security.bcutil.OID;
import com.neo.security.certpath.RFC3280CertPathUtilities;
...
//    private PKCS12BagAttributeCarrier   attrCarrier = new PKCS12BagAttributeCarrierImpl();
    ...
    {
//        Provider    prov = Security.getProvider("NEO");
//
//        if (prov != null)
//        {
...
//        return this.getSigAlgOID();
		...
		return OID.getAlgName(getSigAlgOID());
    }
    ...
    {
    	String algorithm = OID.getAlgName(c.getSubjectPublicKeyInfo().getAlgorithmId().getObjectId().getId());
    	try {
    		KeyFactory keyFact = KeyFactory.getInstance(algorithm,"NEO");

    		return keyFact.generatePublic( new X509EncodedKeySpec(c.getSubjectPublicKeyInfo().getDEREncoded()) );
    	}catch(NoSuchProviderException ex)
    	{
    		IllegalStateException e =  new IllegalStateException("no such provider 'NEO'");
    		ex.initCause(ex);
    		throw e;
    		 
    	}catch(NoSuchAlgorithmException ex)
    	{
    		IllegalStateException e =  new IllegalStateException("algorithm identifier " + algorithm + " in key not recognised");
    		e.initCause(ex);
    		throw e;
...
//    }
        ...
        InvalidKeyException, NoSuchProviderException, SignatureException
    {
        ...
        try
        {
            signature = Signature.getInstance(OID.getAlgName(sigName), "NEO");
        }
        catch (Exception e)
        {
            ...
            SignatureException, InvalidKeyException
    {
        ...
        if (!c.getSignatureAlgorithm().getObjectId().equals(c.getTBSCertificate().getSignature().getObjectId()))
        {
