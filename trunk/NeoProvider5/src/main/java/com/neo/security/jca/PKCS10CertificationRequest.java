...
import com.neo.security.asn1.oid.X9ObjectIdentifiers;
import com.neo.security.asn1.oiw.OIWObjectIdentifiers;
import com.neo.security.asn1.pkcs.CertificationRequest;
import com.neo.security.asn1.pkcs.CertificationRequestInfo;
...
import com.neo.security.bcutil.Strings;
...
//        noParams.add(CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_2001);
                ...
                InvalidKeyException, SignatureException
    {
        ...
        if (provider == null)
        {
            sig = Signature.getInstance(signatureAlgorithm,"NEO");
        }
        else
        {
                ...
                InvalidKeyException, SignatureException
    {
        ...
        try
        {
            if (provider == null)
            {
                sig = Signature.getInstance(getSignatureName(sigAlgId),"NEO");
            }
            else
            {
        ...
        throws NoSuchAlgorithmException, SignatureException, InvalidKeyException
    {
        if (params != null && !DERNull.INSTANCE.equals(params))
        {
			...
			try {
				sigParams = AlgorithmParameters.getInstance(signature.getAlgorithm(), "NEO");
			} catch (NoSuchProviderException e1) {
				throw new NoSuchAlgorithmException(e1.getMessage());
			}
