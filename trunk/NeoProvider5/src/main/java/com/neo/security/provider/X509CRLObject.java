...
import com.neo.security.asn1.x509.CertificateList;
    ...
    extends X509CRL
{
            ...
            InvalidKeyException, NoSuchProviderException, SignatureException
    {
        ...
        String algorithm = OID.getAlgName(getSigAlgName());
        
        Signature sig = Signature.getInstance(algorithm, sigProvider);
