...
import com.neo.security.bcutil.Store;
    ...
    extends PKIXParameters
{
    ...
    private Vector additionalStores;
    ...
    protected void setParams(PKIXParameters params)
    {
        ...
        if (params instanceof ExtendedPKIXParameters)
        {
            ...
            additionalStores = new Vector(_params.additionalStores);
                ...
                if (!(i.next() instanceof Store))
                {
                    throw new ClassCastException(
                        "All elements of list must be "
                            + "of type com.kica.security.util.Store.");
                }
            }
    ...
    public void addAdditionalStore(Store store)
    {
        if (store != null)
        {
            additionalStores.insertElementAt(store, 0);
        }
    }
