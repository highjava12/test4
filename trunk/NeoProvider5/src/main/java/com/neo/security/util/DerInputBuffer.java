...
class DerInputBuffer extends ByteArrayInputStream implements Cloneable {
    ...
    private Date getTime(int len, boolean generalized) throws IOException {
         ...
         */
        sun.util.calendar.CalendarSystem gcal = sun.util.calendar.CalendarSystem.getGregorianCalendar();
        sun.util.calendar.CalendarDate date = gcal.newCalendarDate(null); // no time zone
