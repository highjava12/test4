...
import com.neo.security.util.Debug;
...
abstract class SeedGenerator {
    ...
    final static String URL_DEV_RANDOM = NeoEntries.URL_DEV_RANDOM;
    final static String URL_DEV_URANDOM = NeoEntries.URL_DEV_URANDOM;

    // Static initializer to hook in selected or best performing generator
    static {
        String egdSource = NeoEntries.getSeedSource();
    ...
    static class URLSeedGenerator extends SeedGenerator {
        ...
        private void init() throws IOException {
            ...
            try {
            	...
            	IOException ex = new IOException("Failed to open " + deviceName);
