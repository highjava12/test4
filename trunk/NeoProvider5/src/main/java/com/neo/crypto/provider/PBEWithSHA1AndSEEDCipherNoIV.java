 ...
 * standard, except that is uses SEED.
 *
 ...
 *    form the SEED key, and the last 8 bytes of the 2nd digest form the
 *    IV.
 *
 * @author Jan Luehe
 * @see javax.crypto.Cipher
 */
public final class PBEWithSHA1AndSEEDCipherNoIV extends CipherSpi {
     ...
     */
    public PBEWithSHA1AndSEEDCipherNoIV()
        throws NoSuchAlgorithmException, NoSuchPaddingException
    {
        // set the encapsulated cipher to do SEED
        core = new PBECipherCore("SEED","SHA1",true);
    }
