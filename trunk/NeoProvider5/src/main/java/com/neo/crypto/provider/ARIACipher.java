...
/**
 * This class implements the ARIA algorithm in its various modes
...
public final class ARIACipher extends CipherSpi {
    /*
    ...
    /**
     * Creates an instance of ARIA cipher with default ECB mode and
     * PKCS5Padding.
     */
    public ARIACipher() {
        core = new CipherCore(new ARIACrypt(), ARIAConstants.ARIA_BLOCK_SIZE);
    }
    ...
    protected int engineGetBlockSize() {
        return ARIAConstants.ARIA_BLOCK_SIZE;
    }
    ...
    protected AlgorithmParameters engineGetParameters() {
        return core.getParameters("ARIA");
    }
    ...
    protected int engineGetKeySize(Key key) throws InvalidKeyException {
        ...
        if (!ARIACrypt.isKeySizeValid(encoded.length)) {
            throw new InvalidKeyException("Invalid ARIA key length: " +
