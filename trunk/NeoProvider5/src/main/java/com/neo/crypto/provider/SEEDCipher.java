...
/**
 * This class implements the SEED algorithm in its various modes
...
public final class SEEDCipher extends CipherSpi {
    ...
    /**
     * Creates an instance of SEED cipher with default ECB mode and
     * PKCS5Padding.
     */
    public SEEDCipher() {
        core = new CipherCore(new SEEDCrypt(), SEEDConstants.SEED_BLOCK_SIZE);
    }
    ...
    protected int engineGetBlockSize() {
        return SEEDConstants.SEED_BLOCK_SIZE;
    }
    ...
    protected AlgorithmParameters engineGetParameters() {
        return core.getParameters("SEED");
    }
