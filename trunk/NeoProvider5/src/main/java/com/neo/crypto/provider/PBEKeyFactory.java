...
abstract class PBEKeyFactory extends SecretKeyFactorySpi {
	...
	static {
		...
		validTypes.add("PBEWithSHA1AndSEED".toUpperCase());
	}
	...
	public static final class PBEWithSHA1AndSEED
	extends PBEKeyFactory {
		public PBEWithSHA1AndSEED()  {
			super("PBEWithSHA1AndSEED");
		}
	}
			...
			throws InvalidKeyException
	{
		try {
			if ((key != null) &&
				...
				if (key instanceof com.neo.crypto.provider.PBEKey) {
					return key;
				}
