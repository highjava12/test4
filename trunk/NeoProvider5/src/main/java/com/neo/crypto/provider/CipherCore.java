...
import com.neo.crypto.provider.engine.RC2Crypt;
import com.neo.crypto.provider.engine.SymmetricCipher;
...
final class CipherCore {
        ...
        throws NoSuchPaddingException
    {
        ...
        } else if (!(paddingScheme.equalsIgnoreCase("PKCS5Padding") || !paddingScheme.equalsIgnoreCase("PKCS5"))) {
    ...
    AlgorithmParameters getParameters(String algName) {
        ...
        if (iv != null) {
            ...
            try {
                params = AlgorithmParameters.getInstance(algName, "NEO");
            } catch (NoSuchAlgorithmException nsae) {
                // should never happen
                throw new RuntimeException("Cannot find " + algName +
                    " AlgorithmParameters implementation in NEO provider");
            } catch (NoSuchProviderException nspe) {
                // should never happen
                throw new RuntimeException("Cannot find NEO provider");
            }
            try {
                params.init(ivSpec);
    ...
    void init(int opmode, Key key, AlgorithmParameterSpec params,
        ...
        decrypting = (opmode == Cipher.DECRYPT_MODE) || (opmode == Cipher.UNWRAP_MODE);
    ...
    // each of NEO CipherSpi implementation classes.
