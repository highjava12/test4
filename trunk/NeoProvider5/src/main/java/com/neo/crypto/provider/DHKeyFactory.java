...
/**
 * This class implements the Diffie-Hellman key factory of the Neo provider.
 *
 * @author Jan Luehe
 *
 */
        ...
        throws InvalidKeyException
    {
        try {
            ...
            if (key instanceof javax.crypto.interfaces.DHPublicKey) {
                ...
                if (key instanceof com.neo.crypto.provider.DHPublicKey) {
                    return key;
                }
                // Convert key to spec
                ...
                // Check if key originates from this factory
                if (key instanceof com.neo.crypto.provider.DHPrivateKey) {
                    return key;
                }
                // Convert key to spec
