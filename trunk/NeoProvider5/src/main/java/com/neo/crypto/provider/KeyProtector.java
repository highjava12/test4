...
import com.neo.security.util.ObjectIdentifier;
import com.neo.security.x509.AlgorithmId;
 ...
 * protected. This allows us to parse Neo's keystore implementation that ships
 * with JDK 1.2.
 *
 * @author Jan Luehe
 *
...
final class KeyProtector {
    ...
    private static final Provider PROV = Security.getProvider("NEO");
     ...
     * the recovery algorithm used by Neo's keystore implementation in
     * JDK 1.2.
     */
...
final class SealedObjectForKeyProtector extends javax.crypto.SealedObject {
    ...
    AlgorithmParameters getParameters() {
        ...
        if (super.encodedParams != null) {
            try {
                params = AlgorithmParameters.getInstance("PBE", "NEO");
