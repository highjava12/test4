...
final class AESKey implements SecretKey {
    ...
    /**
     * Uses the first 8 bytes of the given key as the AES key.
     *
     * @param key the buffer with the AES key bytes.
     *
     ...
     * <code>offset</code>, as the AES key
     *
     * @param key the buffer with the AES key bytes.
     * @param offset the offset in <code>key</code>, where the AES key bytes
     * start.
     *
     * @exception InvalidKeyException if less than 8 bytes are available for
     * the key.
     */
    AESKey(byte[] key, int offset,int length) throws InvalidKeyException {
    ...
    /**
     * Replace the AES key to be serialized.
     *
     * @return the standard KeyRep object to be serialized
     *
     * @throws java.io.ObjectStreamException if a new object representing
     * this AES key could not be created
     */
