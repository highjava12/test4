 ...
 * @see FeedbackCipher
 */
abstract public class SymmetricCipher {
     ...
     */
    abstract public  void init(boolean decrypting, String algorithm, byte[] key)
     ...
     */
    abstract public void encryptBlock(byte[] plain, int plainOffset,
     ...
     * @param plainOffset the offset in <code>plain</code>
     */
    abstract public void decryptBlock(byte[] cipher, int cipherOffset,
