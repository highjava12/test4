...
/**
 * This class generates a ARIA key.
 *
 * @author Valerie Peng
 *
 */

public final class ARIAKeyGenerator extends KeyGeneratorSpi {
    ...
    protected void engineInit(AlgorithmParameterSpec params,
        ...
        throws InvalidAlgorithmParameterException {
            throw new InvalidAlgorithmParameterException
                ("ARIA key generation does not take any parameters");
    }
    ...
    protected void engineInit(int keysize, SecureRandom random) {
        if (((keysize % 8) != 0) ||
            (!ARIACrypt.isKeySizeValid(keysize/8))) {
    ...
    /**
     * Generates the ARIA key.
     *
     * @return the new ARIA key
     */
