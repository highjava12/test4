...
final public class DESedeCrypt extends DESCrypt implements DESConstants {
    ...
    public void init(boolean decrypting, String algorithm, byte[] keys)
     ...
     */
    public void encryptBlock(byte[] plain, int plainOffset,
     ...
     * @param plainOffset the offset in <code>plain</code>
     */
    public void decryptBlock(byte[] cipher, int cipherOffset,
